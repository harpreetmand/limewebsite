...
(function () {
  ...
  angular
    ...
    .value('defaultSnapscrollScrollDelay', 0)
    .value('defaultSnapscrollSnapDuration', 1500)
...
(function () {
  ...
  //                 var e = document.getElementById('workPanelInner');
  // var eHeight = e.offsetHeight;
  // var eNewHeight = eHeight - 81;
  // e.style.height = eNewHeight + "px";
